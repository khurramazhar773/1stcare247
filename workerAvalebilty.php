...
<head>
   ...
   .availability-section input[type="text"],
   .availability-section input[type="email"],
   .availability-section input[type="tel"] {
      width: 100%;
      padding: 8px;
      margin-bottom: 10px;
