...
<body>
   ...
   <!-- offer-section -->
   <section>
      <h2 class="hiring-text text-center mb-5">Join Our Healthcare Team</h2>
      <div class="w-100 float-left offer-con hiring-module">
         <div class="container">
            <div class="offer-inner-con banner-overlay-img">
               <div class="row">
                  <!-- Left Section: We are hiring -->

                  <div class="home-col-one col-lg-8 col-md-6 col-sm-12 ">
                     <h2 class="text-white home-banner-heading">We are <span class="text-orange">hiring</span></h2>
                     <p class="text-white offer-p home-banner-inner-text">
                        We are hiring Locum GPs, nurses, healthcare assistants, and pharmacy locums with flexible
                  ...
                  <div class="home-col-two col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="row text-xl-left text-lg-left text-center">
               <div class="col-lg-6">
                  <div class="fun-facts-heading ">
                     <h2>Nurturing Care for Your Complete Recovery.
                     </h2>
                  </div>
               </div>
               <div class="col-lg-6">
                  <div class="fun-facts-content">
                     <p class=" mb-0">Our nurturing care approach ensures your complete recovery, providing personalized
                        support and treatment that fosters healing and promotes overall well-being throughout your
                        journey.</p>
                  </div>
               </div>
            </div>
               ...
               <div class="col-lg-6">
                  <form class="contact-form">
                     <div class="form-group">
                        <label for="exampleFormControlSelect1" class="text-white">Specially</label>
   ...
   <!-- slider-section -->
   <section>
      <div class="w-100 h-60 float-left slider-con text-lg-left text-center  ">
         <div class="container">
