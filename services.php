...
<body>
      ...
      <div class="w-100 float-left service-box-con">
         <div class="container">
            ...
            <div class="service-box-img">
               <figure class="mb-0">
                  <img src="assets/image/services-banner.png" alt="" class="img-fluid">
               </figure>
            </div>
            <div class="service-box-inner-con">
               <div class="row ml-0 mr-0">
               ...
               <div class="col-lg-6 col-md-12">
                  <div class="core-vaule-right-con text-xl-left text-lg-left text-md-left text-center pb-4">
                     <div class="core-vaule-title">
                        ...
                        <p>
                           Our Fundamental Values and Principles guide us in delivering compassionate, ethical, and
                     ...
                     <div class="core-vaule-box-con">
                        <div class="core-vaule-box-item position-relative">
                           <figure class="mb-0">
                              <img src="assets/image/core-vaule-box-icon1.png" alt="core-vaule-box-icon"
                                 class="img-fluid">
                           </figure>
                        ...
                        <div class="core-vaule-box-item position-relative">
                           <figure class="mb-0">
                              <img src="assets/image/core-vaule-box-icon2.png" alt="core-vaule-box-icon"
                                 class="img-fluid">
                           </figure>
                           <div class="core-vaule-box-title">
                        ...
                        <div class="core-vaule-box-item position-relative mb-0">
                           <figure class="mb-0">
                              <img src="assets/image/core-vaule-box-icon3.png" alt="core-vaule-box-icon"
                                 class="img-fluid">
                           </figure>
                           <div class="core-vaule-box-title">
                              <h5>24/7 Helpdesk</h5>
   ...
   <section>
      <div class="w-100 float-left news-letter-con">
         <div class="container">
            <div class="banner-overlay-img banner-section-services">
               <div class="row overlay-img align-items-center">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                     <h4 class="banner-section-heading-inner">
                        Explore our tailored healthcare services for
