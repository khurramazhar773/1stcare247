...
<body>
   ...
   <div class="w-100 mb-5">
      <div class="container">
         <div class="doccument-heading text-center">
            <h2>Forms and Applications</h2>
         </div>
         <!--  -->
         <div class="search-container">
            <input type="text" class="form-control search-input" placeholder="search document">
   ...
   <div class="w-100 float-left form-main-con" id="contact-form">
      <div class="container">
         <div class="text-center">
            ...
            <p>
               Schedule Healthcare Support today and connect with our team of experienced <br> Locum GPs, nurses,
               healthcare
               assistants, and pharmacy locums.<br>
               We provide flexible appointment options to ensure you receive timely,<br> professional care tailored to
               your
               needs
            </p>
         </div>
