                    ...
                    <div class="col-lg-12 d-flex justify-content-center">
                        <form class="contact-form">
                            ...
                            <div class="btnSubmit">
                                ...
                                <button type="submit" class="btn  appointment-btn mb-5">Make Appointment</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <p>Schedule Healthcare Support today and connect with our team of experienced Locum GPs, nurses,
                        healthcare <br> assistants, and pharmacy locums. We provide flexible appointment options to
                        ensure you receive timely, <br> professional care tailored to your needs.
                    </p>
                </div>
                <div class="row">
